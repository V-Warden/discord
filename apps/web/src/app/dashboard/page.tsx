...
const DashboardContent = () => {
	...
	const onSubmit = async (data: z.infer<typeof FormSchema>) => {
		if (session?.user?.id) {
			const response = await updateServer(selectedServer, session.user.id, data)
																...
																render={({ field }) => (
																	<FormItem className='flex gap-5 bg-background/50 flex-row items-center justify-between rounded-md border p-3 shadow-sm w-full md:w-1/2'>
																		<div className='space-y-0.5'>
																			...
																			<FormDescription>
																				Choose the punishment for the "other" type
																			</FormDescription>
																		</div>
																		<FormControl>
																...
																render={({ field }) => (
																	<FormItem className='flex gap-5 bg-background/50 flex-row items-center justify-between rounded-md border p-3 shadow-sm w-full md:w-1/2'>
																		<div className='space-y-0.5'>
																			...
																			<FormDescription>
																				Choose the punishment for the "leaker" type
																			</FormDescription>
																		</div>
																		<FormControl>
																			<Select value={field.value} onValueChange={field.onChange}>
																...
																render={({ field }) => (
																	<FormItem className='flex gap-5 bg-background/50 flex-row items-center justify-between rounded-md border p-3 shadow-sm w-full md:w-1/2'>
																		<div className='space-y-0.5'>
																			...
																			<FormDescription>
																				Choose the punishment for the "cheater" type
																			</FormDescription>
																		</div>
																		<FormControl>
																			<Select value={field.value} onValueChange={field.onChange}>
																...
																render={({ field }) => (
																	<FormItem className='flex gap-5 bg-background/50 flex-row items-center justify-between rounded-md border p-3 shadow-sm w-full md:w-1/2'>
																		<div className='space-y-0.5'>
																			...
																			<FormDescription>
																				Choose the punishment for the "supporter" type
																			</FormDescription>
																		</div>
																		<FormControl>
																			<Select value={field.value} onValueChange={field.onChange}>
															...
															render={({ field }) => (
																<FormItem className='flex gap-5 bg-background/50 flex-row items-center justify-between rounded-md border p-3 shadow-sm'>
																	<div className='space-y-0.5'>
																		...
																		<FormDescription>
																			Select a role to give to a blacklisted user
																		</FormDescription>
																	</div>
																	<FormControl>
																		<Select value={field.value} onValueChange={field.onChange}>
															...
															render={({ field }) => (
																<FormItem className='flex gap-5 bg-background/50 flex-row items-center justify-between rounded-md border p-3 shadow-sm'>
																	<div className='space-y-0.5'>
																		...
																		<FormDescription>
																			Automatically unban users when their appeal is accepted. This
																			is a global setting. When enabled, you can also configure it
																			for each specific type below.
																		</FormDescription>
																	</div>
																	<FormControl>
																		<Switch
