			...
			<div className="mx-auto flex max-w-container flex-col items-center gap-6 sm:gap-20">
				...
				<div className="grid auto-rows-fr grid-cols-1 gap-0 sm:grid-cols-2 sm:gap-3 md:grid-cols-3 lg:grid-cols-3">
					<Item className="animate-appear opacity-0 delay-300">
						...
						<ItemDescription>
							We strive to try and help the leaking and cheating problems within
							the CFX Community. By using Warden, you can help too!
						</ItemDescription>
					</Item>
					<Item className="animate-appear opacity-0 delay-300">
						<FontAwesomeIcon
						...
						<ItemDescription>
							Warden has been designed to let you use it how you see fit.
							Configure it to your hearts desire.
						</ItemDescription>
					</Item>
					<Item className="animate-appear opacity-0 delay-300">
						<FontAwesomeIcon
						...
						<ItemDescription>
							Warden is constantly inspecting new users who join your discord,
